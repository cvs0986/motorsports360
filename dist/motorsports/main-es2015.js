...
let AudiosComponent = class AudiosComponent {
    constructor(messageService, api) {
        ...
        this.api.listAudios().subscribe((resp) => {
            console.log(resp);
            if (resp.status === 200) {
        ...
        this.api.listSeries().subscribe((resp) => {
            if (resp.status === 200) {
                console.log(resp);
        ...
        this.api.listAuthor().subscribe((resp) => {
            if (resp.status === 200) {
                console.log(resp);
    ...
    onSaveConfirm(event) {
        ...
        this.api.updateAudio(event.newData.id, data).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 200) {
    ...
    onDeleteConfirm(event) {
        this.api.deleteAudio(event.data.id).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 204) {
                event.confirm.resolve(this.messageService.add({ severity: 'success', summary: 'Success', detail: 'Updated Successfully' }));
            }
    ...
    publishAudio() {
        ...
        console.log(data);
        this.api.addAudio(data).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 201) {
                this.api.listAudios().subscribe((resp) => {
                    console.log(resp);
...
let AuthorComponent = class AuthorComponent {
    constructor(messageService, api, msg, modalService) {
        this.messageService = messageService;
        this.api = api;
        this.msg = msg;
    ...
    showConfirm(event) {
        this.modalService.confirm({
            ...
            nzOkLoading: false,
            nzOnOk: () => {
                this.api.deleteAuthor(event.data.id).subscribe((resp) => {
                    if (resp.status === 204) {
                        this.api.listAuthor().subscribe((resp) => {
                            if (resp.status === 200) {
                                console.log(resp);
    ...
    handleOk() {
        ...
        this.api.updateAuthor(this.authorID, formData).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 200) {
                this.api.listAuthor().subscribe((resp) => {
                    if (resp.status === 200) {
    ...
    showScrappingConfirm(event) {
        this.modalService.confirm({
            ...
            nzOnOk: () => {
                ...
                this.isSpinning = true;
                this.api.scrapAuthor(formData).subscribe((resp) => {
    ...
    publishAuthor() {
        ...
        formData.append('name', this.name);
        this.isLoadingTwo = true;
        this.api.addAuthor(formData).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 201) {
                this.api.listAuthor().subscribe((resp) => {
                    if (resp.status === 200) {
...
let DriversComponent = class DriversComponent {
    ...
    constructor(messageService, api, msg, modalService) {
        ...
        this.api.getBannerImages().subscribe((resp) => {
            console.log(resp);
    ...
    driverAvatarChange(info) {
        ...
        this.getBase64(info.file.originFileObj, (img) => {
            ...
            this.api.updateDriverBanner(1, data).subscribe((resp) => {
    ...
    teamAvatarChange(info) {
        ...
        this.getBase64(info.file.originFileObj, (img) => {
            ...
            this.api.updateTeamBanner(1, data).subscribe((resp) => {
    ...
    eventAvatarChange(info) {
        ...
        this.getBase64(info.file.originFileObj, (img) => {
            ...
            // };
            this.api.updateEventBanner(1, data).subscribe((resp) => {
    ...
    leaderAvatarChange(info) {
        ...
        this.getBase64(info.file.originFileObj, (img) => {
            ...
            //   event_banner_image: this.eventAvatarFile
            // };
            this.api.updateLeaderBanner(1, data).subscribe((resp) => {
    ...
    seriesAvatarChange(info) {
        ...
        this.getBase64(info.file.originFileObj, (img) => {
            ...
            this.api.updateSeriesBanner(1, data).subscribe((resp) => {
    ...
    ngOnInit() {
        this.isSpinning = true;
        this.api.listDrivers().subscribe((resp) => {
            if (resp.status === 200) {
                console.log(resp);
                this.data = resp.body.results;
                this.isSpinning = false;
    ...
    onSaveConfirm(event) {
        ...
        this.api.updateDrivers(event.newData.id, data).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 200) {
                event.confirm.resolve(this.messageService.add({ severity: 'success', summary: 'Success', detail: 'Updated Successfully' }));
            }
...
let NewsComponent = class NewsComponent {
    constructor(messageService, api, modalService) {
        this.messageService = messageService;
        this.api = api;
        this.modalService = modalService;
        this.isSpinning = false;
        ...
        this.isSpinning = true;
        this.api.listNews().subscribe((resp) => {
            if (resp.status === 200) {
                console.log(resp);
                this.data = resp.body.results;
                this.isSpinning = false;
    ...
    onSaveConfirm(event) {
        ...
        this.isSpinning = true;
        this.api.updateNews(event.newData.id, data).subscribe((resp) => {
            if (resp.status === 200) {
                this.isSpinning = false;
                event.confirm.resolve(this.messageService.add({ severity: 'success', summary: 'Success', detail: 'Updated Successfully' }));
            }
    ...
    showTrendingConfirm(event) {
        ...
        this.modalService.confirm({
            ...
            nzOnOk: () => {
                ...
                this.api.updateNews(event.data.id, data).subscribe((resp) => {
                    if (resp.status === 200) {
    ...
    showConfirm(event) {
        this.modalService.confirm({
            ...
            nzOkLoading: false,
            nzOnOk: () => {
                this.api.deleteNews(event.data.id).subscribe((resp) => {
                    console.log(resp);
                    if (resp.status === 204) {
                        console.log(resp);
    ...
    publishNews() {
        ...
        this.api.addNews(newsData).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 201) {
                this.api.listNews().subscribe((resp) => {
                    if (resp.status === 200) {
...
let SeriesComponent = class SeriesComponent {
    ...
    showConfirm(event) {
        this.modalService.confirm({
            ...
            nzOkLoading: false,
            nzOnOk: () => {
                this.api.deleteSeries(event.data.id).subscribe((resp) => {
                    console.log(resp);
                    if (resp.status === 204) {
    ...
    handleOk() {
        ...
        formData.append('name', this.name);
        formData.append('id', this.authorID);
        this.api.updateSeries(this.authorID, formData).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 200) {
                this.api.listSeries().subscribe(
                // tslint:disable-next-line: no-shadowed-variable
    ...
    publishSeries() {
        ...
        this.isLoadingTwo = true;
        this.api.addSeries(formData).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 201) {
                this.api.listSeries().subscribe(
                // tslint:disable-next-line: no-shadowed-variable
...
let AudioTilesComponent = class AudioTilesComponent {
    constructor(messageService, api) {
        this.messageService = messageService;
        this.api = api;
        this.isSpinning = false;
        ...
        this.isSpinning = true;
        this.api.listAudioTiles().subscribe((resp) => {
            console.log(resp);
            if (resp.status === 200) {
                this.data = resp.body.results;
                this.isSpinning = false;
    ...
    onSaveConfirm(event) {
        ...
        console.log(event);
        this.api.updateAudioTiles(event.newData.id, data).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 200) {
                event.confirm.resolve(this.messageService.add({ severity: 'success', summary: 'Success', detail: 'Updated Successfully' }));
            }
    ...
    onDeleteConfirm(event) {
        this.api.deleteAudioTiles(event.data.id).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 204) {
                event.confirm.resolve(this.messageService.add({ severity: 'success', summary: 'Success', detail: 'Updated Successfully' }));
            }
    ...
    publishAudio() {
        ...
        this.api.addAudioTiles(formData).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 201) {
                this.api.listAudioTiles().subscribe((resp) => {
                    console.log(resp);
...
let VidoesTilesComponent = class VidoesTilesComponent {
    constructor(messageService, api) {
        this.messageService = messageService;
        this.api = api;
        this.isSpinning = false;
        ...
        this.isSpinning = true;
        this.api.listVideoTiles().subscribe((resp) => {
            console.log(resp);
            if (resp.status === 200) {
                this.data = resp.body.results;
                this.isSpinning = false;
    ...
    onSaveConfirm(event) {
        ...
        this.api.updateVideoTiles(event.newData.id, data).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 200) {
                event.confirm.resolve(this.messageService.add({ severity: 'success', summary: 'Success', detail: 'Updated Successfully' }));
            }
    ...
    onDeleteConfirm(event) {
        this.api.deleteVideoTiles(event.data.id).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 204) {
                event.confirm.resolve(this.messageService.add({ severity: 'success', summary: 'Success', detail: 'Updated Successfully' }));
            }
    ...
    publishVideo() {
        ...
        this.isLoadingTwo = true;
        console.log(formData);
        this.api.addVideoTiles(formData).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 201) {
                this.api.listVideoTiles().subscribe((resp) => {
                    console.log(resp);
...
let VidoesComponent = class VidoesComponent {
    constructor(messageService, api) {
        this.messageService = messageService;
        this.api = api;
        this.isSpinning = false;
        ...
        this.isSpinning = true;
        this.api.listVidoes().subscribe((resp) => {
            console.log(resp);
            if (resp.status === 200) {
                this.data = resp.body.results;
                this.isSpinning = false;
    ...
    onSaveConfirm(event) {
        ...
        this.api.updateVideo(event.newData.id, data).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 200) {
                event.confirm.resolve(this.messageService.add({ severity: 'success', summary: 'Success', detail: 'Updated Successfully' }));
            }
    ...
    onDeleteConfirm(event) {
        this.api.deleteVideo(event.data.id).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 204) {
                event.confirm.resolve(this.messageService.add({ severity: 'success', summary: 'Success', detail: 'Updated Successfully' }));
            }
    ...
    publishVideo() {
        ...
        this.isLoadingTwo = true;
        console.log(data);
        this.api.addVideo(data).subscribe((resp) => {
            console.log(resp);
            if (resp.status === 201) {
                this.api.listVidoes().subscribe((resp) => {
                    console.log(resp);
...
/* harmony import */ var ng2_smart_table__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ng2-smart-table */ "./node_modules/ng2-smart-table/fesm2015/ng2-smart-table.js");
/* harmony import */ var ng_zorro_antd_checkbox__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ng-zorro-antd/checkbox */ "./node_modules/ng-zorro-antd/fesm2015/ng-zorro-antd-checkbox.js");
/* harmony import */ var ng_zorro_antd__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ng-zorro-antd */ "./node_modules/ng-zorro-antd/fesm2015/ng-zorro-antd.js");
...
let LoginComponent = class LoginComponent {
    constructor(route, router, messageService, api) {
        this.route = route;
        this.router = router;
        this.messageService = messageService;
        this.api = api;
    ...
    userLogin() {
        ...
        if (this.username == '' || this.username == undefined) {
            ...
            this.isLoading = true;
            this.api.login(loginData).subscribe((resp) => {
                console.log(resp);
                if (resp.status === 200) {
                    this.isLoading = false;
